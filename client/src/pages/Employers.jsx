...
const Employers = () => {
  ...
  return (
    ...
    >
      ...
      {/* Main Layout Wrapper: flex-col for mobile, flex-row for desktop */}
      <div className="flex flex-col md:flex-row w-full mx-auto relative">
        ...
        <div className="md:hidden p-4 bg-[#fce3cd]/50 border-b border-[#fce3cd] flex justify-between items-center sticky top-0 z-30 backdrop-blur-sm">
          <h1 className="text-xl font-bold text-amber-900">Employers</h1>
          <button
        ...
        {/* Sidebar Filter Area */}
        {/* Using standard div with conditional classes for responsive behavior */}
        <div
          className={`
            ...
            md:translate-x-0 md:static md:w-1/4 md:shadow-none md:h-auto md:border-r md:border-[#fce3cd] md:bg-[#fce3cd]/70
        ...
        >
          <div className="p-6">
            <div className="flex justify-between items-center mb-4">
              ...
              {getActiveFilterCount() > 0 && (
                <button
                  className="hidden md:block text-sm text-amber-800 hover:text-amber-600"
                  onClick={clearFilters}
                >
                  Clear All
                </button>
            ...
            {/* Mobile Clear All (if needed prominently) */}
            {getActiveFilterCount() > 0 && (
              <button
        ...
        {/* Main Content Area */}
        <motion.div
          className="w-full md:w-3/4 p-4 md:p-6 bg-[#f6f6ef]"
          initial={{ x: 50, opacity: 0 }}
          animate={{ x: 0, opacity: 1 }}
          transition={{ duration: 0.6, ease: "easeOut" }}
        >
          ...
          {/* Mobile Results count (since header is hidden on mobile) */}
          <div className="md:hidden flex justify-between items-center mb-4 text-sm text-amber-800">
            <span>{filteredEmployers.length} results found</span>
          </div>
